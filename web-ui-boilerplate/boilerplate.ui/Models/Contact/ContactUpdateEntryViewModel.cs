...
{
    public class ContactUpdateEntryViewModel : ContactEntryViewModelBase<ContactUpdateEntryViewModel.FormModel>
    {
        public IEnumerable<ReferenceReportModel> MusicianContacts { get; internal set; }
        public IEnumerable<ReferenceReportModel> MusicLabelContacts { get; internal set; }
        public IEnumerable<ReferenceReportModel> PlatformContacts { get; internal set; }
